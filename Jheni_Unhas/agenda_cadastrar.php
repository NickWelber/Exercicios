			...
			<?php
				...
				while($linha = $result->fetch_assoc() ){
					...
					<tr class="agenda-item">
						<td class="agenda-id_agenda">' .$linha['id_agenda']. '</td>
						<td class="agenda-data_servico">' .$linha['data_servico']. '</td>
						<td class="agenda-horario_servico">' .$linha['horario_servico']. '</td>
						<td class="agenda-situacao">' .$linha['situacao']. '</td>
						<td class="agenda-id_cliente">' .$linha['id_cliente']. '</td>
						<td class="agenda-id_manicure">' .$linha['id_manicure']. '</td>
						<td class="agenda-id_servico">' .$linha['id_servico']. '</td>
						<td class="text-center">
							<div class="agenda-change-status">
								<i class="material-icons text-success" data-toggle="tooltip" 
									title="" data-original-title="Mudar status">check
								</i>
							</div>
						</td>
						<td class="text-center">
